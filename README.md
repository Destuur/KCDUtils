...
**Version:** <!--VERSION-->0.0.20<!--/VERSION-->  
**Author:** Destuur  
...
This project is released under the MIT License. See the [`LICENSE`](https://github.com/Destuur/KCDUtils/blob/main/LICENCE) file for details.
